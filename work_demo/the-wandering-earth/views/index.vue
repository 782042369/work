 ...
 * @LastEditors: 杨宏旋
 * @LastEditTime: 2019-02-15 17:24:48
 * @Description: 流浪地球
-->
<template>
  <div class="warp">
...
import { DOWNLOAD_APP, VUE_APP_MALL } from '@/lib/consts'; // 下载页面
export default {
  mixins: [shareWx],
  data() {
    return {
  ...
  created() {
    if (this.$wxBrowser === 'none') {
      window.location.href = `${DOWNLOAD_APP}?url=${VUE_APP_MALL}/#/goods-detail?id=16`;
    }
    setRightButton({
      title: '分享',
      eventId: 'eventId'
