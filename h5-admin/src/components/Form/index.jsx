...
class BaseForm extends React.Component {
	...
	// inputtypearr = new Map()
	// 	.set('input', <Input placeholder={placeholder} />)
	// 	.set(
	// 		'select',
	...
	// 		</Select>
	// 	)
	// 	.set('checkbox', <Checkbox>{lable}</Checkbox>)
	// 	.set('date', <DatePicker showTime for-mat="YY-MM-DD HH:mm:ss" placeholder={placeholder} />)
	// 	.set('textarea', <TextArea placeholder={placeholder} />)
