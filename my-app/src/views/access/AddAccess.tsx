 ...
 * @LastEditTime: 2019-05-24 17:32:12
 */
...
interface Props {}
class manger extends React.Component<Props, State> {
	...
	render() {
		return <BashForm formList={this.formList} h1title={this.state.h1title} formSubmit={this.handleSubmit} />
	}
}
