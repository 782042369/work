...
const Article = AsyncComponent(() => import(/* webpackChunkName: "Article" */ '../views/article'))
const AddArticle = AsyncComponent(() => import(/* webpackChunkName: "AddArticle" */ '../views/article/AddArticle'))
let router = [
	{
		path: '/access',
		component: Access
