<template>
  <div @click.self="closeLogin" class="mask" v-show="isKeep">
    <div class="mask-content">
      <ul>
        <li>
          <input placeholder="请输入手机号" ref='phone' maxlength="11" @blur="scollorZeroPhone" type="tel" v-model="tel">
        </li>
        <li>
          <input class="code" ref='code' placeholder="请输入验证码" @blur="scollorZero" maxlength="6" type="text" v-model="code">
...
.mask {
  ...
  .goLogin {
    ...
    width: 500px;
    line-height: 100px;
    background-image: linear-gradient(-74deg, #02e26e 0%, #06c461 99%);
    border-radius: 50px;
    font-size: 40px;
    color: #fff;
    text-align: center;
